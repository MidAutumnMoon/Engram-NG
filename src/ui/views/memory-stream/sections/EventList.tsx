                ...
                : (
                    <GroupedVirtuoso
                        ...
                        groupContent={(index) => {
                            ...
                            const allChecked = group.events.length > 0 &&
                                group.events.every((e) => checkedIds.has(e.id));
                            const someChecked = group.events.some((e) =>
                                checkedIds.has(e.id)
                            );
                        ...
                        itemContent={(index, groupIndex) => {
                            ...
                            const itemIndex = index -
                                (groupStartIndices[groupIndex] || 0);
                            ...
                            const isLast =
                                itemIndex === group.events.length - 1;
                                    ...
                                    <div className="relative z-10 w-full pl-3">
                                        <ErrorBoundary>
                                            <EventCard
                                                ...
                                                isActive={activeIds.has(
                                                    event.id,
                                                )}
                                                checked={checkedIds.has(
                                                    event.id,
                                                )}
                                                hasChanges={pendingChanges.has(
                                                    event.id,
                                                )}
                                                onSelect={() =>
                                                    onSelect(event.id)}
                                                onCheck={(checked) =>
                                                    onCheck(event.id, checked)}
