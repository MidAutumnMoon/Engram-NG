                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <button
                                                ...
                                                disabled={status
                                                    .lastSummarizedFloor ===
                                                    editSummarizedFloor}
                                                className="text-[10px] px-2 py-1 rounded bg-muted/50 text-muted-foreground hover:text-foreground hover:bg-muted disabled:opacity-30"
                                            >
                                                设置
                                            </button>
                                        </div>
                ...
                >
                    ...
                    <div className="space-y-3">
                        ...
                        <SliderField
                            ...
                            onChange={(val) => {
                                const key = trimConfig.trigger === "token"
                                    ? "tokenLimit"
                                    : "countLimit";
                    ...
                    <div className="space-y-3">
                        ...
                        <SliderField
                            ...
                            onChange={(val) =>
                                handleLimitChange("keepRecentCount", val)}
                        />
                    </div>
                    ...
                    {trimStatus && (
                        <div className="text-xs text-muted-foreground space-y-1">
                            <div className="flex justify-between">
                                <span>待合并条目:</span>
                                <span className="font-mono">
                                    {trimStatus.pendingEntryCount}
                                </span>
                            </div>
                            <div className="flex justify-between">
                                <span>
                                    当前{trimConfig.trigger === "token"
                                        ? "Token"
                                        : "条目数"}:
                                </span>
                                <span
                                    className={`font-mono ${
                                        trimStatus.triggered
                                            ? "text-amber-500"
                                            : ""
                                    }`}
                                >
                                    {trimStatus.currentValue} /{" "}
                                    {limitConfig.value}
                                </span>
                            </div>
                        </div>
                    ...
                    <button
                        type="button"
                        className="inline-flex items-center gap-2 px-4 py-2 text-sm text-muted-foreground hover:text-foreground border border-border rounded-lg hover:border-foreground/30 disabled:opacity-50"
                        onClick={handleTriggerTrim}
                        disabled={trimLoading ||
                            (trimStatus?.pendingEntryCount ?? 0) < 2}
                    >
                        <Scissors
                            size={14}
                            className={trimLoading ? "animate-pulse" : ""}
                        />
