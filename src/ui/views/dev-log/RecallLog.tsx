...
const LogListItem: React.FC<LogListItemProps> = (
    ...
    return (
        <div className={`flex flex-col h-full ${isFullScreen ? "p-4" : ""}`}>
            ...
            <div className="mb-4 pb-4 border-b border-border shrink-0">
                ...
                {entry.preprocessedQuery &&
                    entry.preprocessedQuery !== entry.query && (
                            ...
                            <table className="w-full text-[10px] text-left">
                                <thead className="bg-muted/30 text-muted-foreground">
                                    <tr>
                                        ...
                                        <th className="p-1.5 font-medium text-right">
                                            Score
                                        </th>
                                        <th className="p-1.5 font-medium text-right">
                                            Count
                                ...
                                <tbody>
                                    {entry.brainStats.snapshot.map((slot) => (
                                        ...
                                        >
                                            <td
                                                className="p-1.5 truncate max-w-[80px]"
                                                title={slot.id}
                                            >
                                                {slot.label ||
                                                    slot.id.slice(0, 8)}
