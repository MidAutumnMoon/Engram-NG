...
const DEFAULT_TIMEOUT = 10_000; // 10秒
...
export async function fetchOpenAIModels(
    ...
    try {
        ...
        // 使用酒馆后端代理获取模型列表，解决 CORS 问题。
        // 利用 OpenAI 源的 reverse_proxy 逻辑通过后端转发。
        ...
        // 酒馆后端透传 API 响应；OpenAI 兼容接口的 models 列表在 data.data 下。
